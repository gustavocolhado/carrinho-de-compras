        ...
        <div className="w-full max-w-7xl mx-auto">
            ...
            {cart.map( (item) => (
                ...
                <div className="flex items-center justify-center gap-3">
                    <button className="bg-slate-600 rounded px-2 text-white items-center justify-center" onClick={ () => removeItemCart(item)}>
                        -
                    </button>
                    {item.amount}
                    <button className="bg-slate-600 rounded px-2 text-white items-center justify-center" onClick={ () => addItemCart(item)}>
                        +
                    </button>
                </div>
